...
sgd = SGD(lr = 0.001, decay=1e-6, momentum=0.9, nesterov=True) # momentum and nestrov are internet std vals
model.compile(loss = 'categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])
mod = model.fit(np.array(train_x), np.array(train_y), epochs=10000, batch_size=5, verbose= 1)
